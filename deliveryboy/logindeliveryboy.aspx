<%@ Page Language="C#" AutoEventWireup="true" CodeFile="logindeliveryboy.aspx.cs" Inherits="deliveryboy_logindeliveryboy" %>
                    ...
                    <div class="row">
                        <div class="col-md-6 center">
                            ...
                            <div class="panel info-box panel-white" style="border-radius: 2rem 2rem 2rem 2rem !important">
                                <div class="login-box">
                                    <br />
                                    <a href="#" target="_blank" class="logo-name text-lg text-center">Food Store Delivery Partner</a>
                                    ...
                                    <div class="m-t-md">
                                        ...
                                        <button type="submit" id="btnlogin" onserverclick="btnlogin_ServerClick" class="btn btn-danger btn-block" runat="server">Login</button>
                                        <br />
                                        <br />
                                    </div>
