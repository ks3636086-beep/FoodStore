                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <button type="button" id="btndelete1" runat="server" class="btn btn-danger" style="margin-top: 22px; float: right; margin-left: 5px;" onserverclick="btndelete_ServerClick1">Top Selling</button>
                                    <button type="button" id="btndelete2" runat="server" class="btn btn-danger" style="margin-top: 22px; float: right; margin-left: 5px;" onserverclick="btndelete_ServerClick2">Featured</button>
